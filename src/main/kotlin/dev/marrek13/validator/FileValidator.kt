...
object FileValidator {
     ...
     */
    fun isSupported(file: File) = file.isFile() && extensions.contains(FilenameUtils.getExtension(file.getName()))
     ...
     */
    fun containsIndex(files: List<File>) =
        files.any { it.isFile() && FilenameUtils.getName(it.getName()) == INDEX_HTML }
}
