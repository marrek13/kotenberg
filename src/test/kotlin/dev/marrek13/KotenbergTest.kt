...
class KotenbergTest {
    ...
    @Test
    fun `should throw exception when trying to convert empty list`() =
        runTest {
            val kotenberg = Kotenberg(gotenbergTestContainer.endpoint)
    ...
    @Test
    fun `should throw exception when trying to convert non-PDF files`() =
        runTest {
            val kotenberg = Kotenberg(gotenbergTestContainer.endpoint)
    ...
    @Test
    fun `should convert with pdf engines`() =
        runTest {
            val kotenberg = Kotenberg(gotenbergTestContainer.endpoint)
    ...
    @Test
    fun `should convert multiple files with pdf engines to zip`() =
        runTest {
            val kotenberg = Kotenberg(gotenbergTestContainer.endpoint)
    ...
    @Test
    fun `should throw exception when trying to merge empty list`() =
        runTest {
            val kotenberg = Kotenberg(gotenbergTestContainer.endpoint)
    ...
    @Test
    fun `should throw exception when trying to merge non-PDF files`() =
        runTest {
            val kotenberg = Kotenberg(gotenbergTestContainer.endpoint)
    ...
    @Test
    fun `should merge with pdf engines`() =
        runTest {
            val kotenberg = Kotenberg(gotenbergTestContainer.endpoint)
